/**
 * Design reminder — 항공 라운지 글래스: 프로필은 설정의 나열보다,
 * 또잇이 여행 취향을 얼마나 이해하는지 보여 주는 개인 제어 패널이다.
 */
...
export default function Profile() {
  return (
    <AppShell eyebrow="MY TRAVEL TASTE" title="당신의 여행은,
어떤 속도인가요?">
      ...
      <section className="taste-card"><span className="section-kicker">CURRENT PACE</span><h2>하루 3곳, 조금 여유롭게.</h2><p>일정을 빼곡하게 채우기보다, 좋아하는 곳에서 오래 머무는 편이에요.</p><div><span>아침 산책</span><span>오후 전시</span><span>저녁 식사</span></div></section>
      <section className="profile-passport">
        <div className="passport-topline"><span className="section-kicker">NEXT BOARDING PASS</span><span><Plane size={13} /> D-79</span></div>
