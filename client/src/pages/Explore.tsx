/**
 * Design reminder — 항공 라운지 글래스: 탐색은 콘텐츠 나열보다,
 * 여행을 바로 계획으로 옮길 수 있는 조용한 시작점으로 설계한다.
 */
...
export default function Explore() {
  return (
    <AppShell eyebrow="EXPLORE" title="어디로 갈까요?">
      ...
      <section className="departure-card">
        ...
        <div className="departure-topline"><span><Sparkles size={15} /> CURATED FOR YOU</span><span className="boarding-tag">NXT 02</span></div>
        <div className="departure-route"><span>ICN</span><i /><b><MapPin size={13} /></b><i /><span>FUK</span></div>
        <div className="departure-copy"><h2>후쿠오카의 느린<br /><em>주말을 만나 보세요.</em></h2><p>커피, 산책, 작은 전시를 좋아하는 취향을 기준으로 골랐어요.</p></div>
      ...
      <section className="explore-document">
        <div className="document-heading"><span className="section-kicker">YOUR BOARDING NOTES</span><strong>여행 취향을 더 알려 주세요</strong></div>
